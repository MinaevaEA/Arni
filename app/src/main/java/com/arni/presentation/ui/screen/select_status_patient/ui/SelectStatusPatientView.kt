...
@Composable
fun SelectStatusPatientView(
    state: SelectStatusPatientState,
    eventConsumer: (SelectStatusPatientEvent) -> Unit
) {
    ...
    Column(
        ...
        TextTitleToolbar(onBackPressed = {
            eventConsumer.invoke(SelectStatusPatientEvent.OnBackCLickEvent)
...
@Composable
@Preview
fun SelectStatusPatientViewPreview() {
    ArniTheme {
        SelectStatusPatientView(state = SelectStatusPatientState(), eventConsumer = {})
    }
}
